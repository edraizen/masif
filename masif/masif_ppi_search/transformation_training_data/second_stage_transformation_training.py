...
from  masif.masif_ppi_search.transformation_training_data.second_stage_transformation_training_helper import *
# coding: utf-8
import sys
from open3d import *
#import ipdb
...
data_dir = sys.argv[1]
if data_dir.startswith("{masif_source}"):
    data_dir = data_dir.format(masif_source=os.dirname(os.dirname(os.dirname(__file__))))
