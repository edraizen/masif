...
from masif.triangulation.xyzrn import output_pdb_as_xyzrn
from masif.default_config.global_vars import msms_bin
...
def computeMSMS(pdb_file, protonate=True, return_msms_file=False):
    ...
    if return_msms_file:
        return vertices, faces, normals, names, areas, file_base
