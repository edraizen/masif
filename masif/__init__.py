...
def main(args=None):
    ...
    if args.masif_app == "ligand":
        for pdb_chain in args.pdb_pair_id:
            prepare(pdb_chain, masif_app="masif_ligand", bio=args.bio, file=args.file)
    elif args.masif_app == "site":
        for pdb_chain in args.pdb_pair_id:
            prepare(pdb_chain, masif_app="masif_site", bio=args.bio, file=args.file)
    elif args.masif_app == "ppi_search":
        for pdb_chain in args.pdb_pair_id:
            prepare(pdb_chain, masif_app="masif_ppi_search", bio=args.bio, file=args.file, nn_model=args.nn_model)
