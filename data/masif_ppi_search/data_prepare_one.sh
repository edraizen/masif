...
python -m masif.data_preparation.01-pdb_extract_and_triangulate $PDB_ID\_$CHAIN1
python -m masif.data_preparation.01-pdb_extract_and_triangulate $PDB_ID\_$CHAIN2
